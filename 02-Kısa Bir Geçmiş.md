...
saðladý ve bugün halen Web Uygulamalarý geliþtirirken kullanýlan yegane betik dilidir.

Diðer diller halen varlýklarýný devam ettiriyor fakat hepsi JavaScript'e derlenmek(compile) mecburiyetinde ya da son zamanlardaki WebAssembly'e.
Bu baþka bir hikayenin konusu.

Baþlangýçta JavaScript bugünkü kadar güçlü deðildi ve genellikle yanarlý-dönerli animasyonlar ve o zaman bir mucize olarak
bilinen Dinamik HTML için kullanýlýyordu.

Web platformunun talep ettiði ve etmeye devam ettiði artan ihtiyaçlarla birlikte JavaScript'in de dünyanýn en çok kullanýlan
ekosisteminin ihtiyaçlarýný karþýlama sorumluluðu arttý.

JavaScript þu anda bir taraftan da databaseleri(veritabanlarýný) ve daha birçok uygulamayý destekleyen bir dil haline geldi. Hatta þu anda
gömülü uygulamalar, mobil uygulamalar, TV uygulamalarý ve daha fazlasýný geliþtirebilmek mümkün bu dille. Bir tarayýcýda çalýþan mütevazý bir
dil olarak baþlayan þey þimdi dünyadaki en popüler dil haline geldi.
